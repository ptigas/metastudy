"""The `fit` function in this file implements a slightly modified version of
the Keras `model.fit()` API."""
...
from few_shot.callbacks import CallbackList
from few_shot.callbacks import DefaultCallback
from few_shot.callbacks import ProgressBarLogger
