"""Run this script to prepare the Omniglot dataset from the raw Omniglot
dataset that is found at
...
for root, alphabets, _ in os.walk(prepared_omniglot_location +
                                  'images_background/'):
